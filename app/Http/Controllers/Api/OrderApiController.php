...
class OrderApiController extends Controller
{
    public function store(Request $request)
    {
        try {
            ...
            // ✅ Flexible validation for both regular and draft orders
            ...
            // ✅ Create order with user_id field
            $orderData = [
    ...
    // Add method to convert draft to completed order
    public function convertDraftToOrder(Request $request, $draftId)
    {
        try {
            ...
            $draft->update([
                'status' => 'completed',
                'order_number' => $this->generateOrderNumber(), // Generate new order number
            ]);
    ...
    // Add this method to your OrderApiController
    public function getReceipt($id)
    {
        try {
            $order = Order::with(['customer', 'items.product', 'payment'])
                        ->findOrFail($id);
            ...
            return response()->json([
                ...
                'receipt_data' => [
                    ...
                    'payment_details' => $order->payment ? [
                        'amount_received' => $order->payment->amount_received,
